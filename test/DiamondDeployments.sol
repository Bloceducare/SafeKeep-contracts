...
import "../contracts/Vault/facets/UpgradeFacetWithModule.sol";
...
import "../contracts/VaultFactory/facets/ModuleUpgraderFacet.sol";
...
import {ModuleAlreadyAdded} from "../contracts/VaultFactory/libraries/LibModuleUpgrades.sol";
...
contract DDeployments is Test {
    ...
    function setUp() public {
        ...
        VUpgraderFacet = new UpgradeFacetWithModule();
        ...
        FUpgradeFacet = new ModuleUpgraderFacet();
        ...
        cut[2] = IDiamondCut.FacetCut({
            facetAddress: address(FUpgradeFacet),
            action: IDiamondCut.FacetCutAction.Add,
            functionSelectors: generateSelectors("ModuleUpgraderFacet")
        });
        ...
        selectorCut[4] = IDiamondCut.FacetCut({
            facetAddress: address(VUpgraderFacet),
            action: IDiamondCut.FacetCutAction.Add,
            functionSelectors: generateSelectors("UpgradeFacetWithModule")
        });
        ...
        UpgradeFacetWithModule(address(vault1)).upgradeModule("DMS");
    ...
    function testDefaultModules() public {
        ...
        UpgradeFacetWithModule(address(vault1)).upgradeModule("Selector");

        // downgrade an already exosting vault
        UpgradeFacetWithModule(address(vault1)).downgradeModule("Selector");
        // vm.stopPrank();
    }
