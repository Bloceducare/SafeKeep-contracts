...
v1ERC20Facet.batchWithdrawERC20Token(toDualAdd(address(erc20t),address(erc20t2)),toDualUINT(v1erc20BalanceT1,v1erc20BalanceT2+10),depositor1);

//withdraw normally
//remove all of token2
v1ERC20Facet.batchWithdrawERC20Token(toDualAdd(address(erc20t),address(erc20t2)),toDualUINT(v1erc20BalanceT1-90e18,v1erc20BalanceT2),depositor1);
...
v1VaultFacet.allocateERC20Tokens(address(erc20t),toSingletonAdd(vault1Inheritor2),toSingletonUINT(v1erc20BalanceT1));
...
v1VaultFacet.allocateERC20Tokens(address(erc20t),toSingletonAdd(vault1Inheritor2),toSingletonUINT(inheritor2T1Alloc-50e18));
...
v1VaultFacet.allocateERC20Tokens(address(erc20t),toSingletonAdd(vault1Inheritor1),toSingletonUINT(inheritor2T1Alloc-20e18));
