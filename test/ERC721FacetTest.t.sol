...
v1VaultFacet.allocateERC721Tokens(address(erc721t),toSingletonAdd(vault1Inheritor1),toSingletonUINT(9));

//trying to allocate a token not owned by the vault should not revert the whole txn
v1VaultFacet.allocateERC721Tokens(address(erc721t),toDualAdd(vault1Inheritor1,vault1Inheritor1),toDualUINT(0,3));

//confirm storage
ERC721Facet.AllocatedERC721Tokens[] memory vault1Inheritor1Alloc= v1ERC721Facet.getAllocatedERC721Tokens(vault1Inheritor1);
...
v1VaultFacet.allocateERC721Tokens(address(erc721t),toSingletonAdd(vault1Inheritor2),toSingletonUINT(0));

//confirm storage
ERC721Facet.AllocatedERC721Tokens[] memory vault1Inheritor2Alloc= v1ERC721Facet.getAllocatedERC721Tokens(vault1Inheritor2);
...
vault1Inheritor1Alloc= v1ERC721Facet.getAllocatedERC721Tokens(vault1Inheritor1);
assertEq(vault1Inheritor1Alloc.length,0);


//unallocate and withdraw
v1VaultFacet.allocateERC721Tokens(address(erc721t),toSingletonAdd(address(0)),toSingletonUINT(0));
assertEq(v1ERC721Facet.getAllocatedERC721TokenIds(vault1Inheritor2,address(erc721t)).length,0);
 //withdraw the token
v1ERC721Facet.withdrawERC721Token(address(erc721t),0,vault1Owner);
//confirm ownership
...
v1VaultFacet.allocateERC721Tokens(address(erc721t2),toTriAddress(vault1Inheritor2,vault1Inheritor2,vault1Inheritor2),toTriUINT(0,1,2));
