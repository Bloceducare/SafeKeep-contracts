...
contract ERC721FacetTest is DDeployments {
    ...
    function testERC721VaultOperations() public {
        ...
        v1ERC721Facet.depositERC721Tokens(
            address(erc721t2),
            toTriUINT(0, 1, 2)
        );
        ...
        v1dmsFacet.allocateERC721Tokens(
            address(erc721t),
            toDualAdd(vault1Inheritor1, vault1Inheritor1),
            toDualUINT(0, 3)
        );

        //     //confirm storage
        DMSFacet.AllocatedERC721Tokens[]
            memory vault1Inheritor1Alloc = v1dmsFacet.getAllocatedERC721Tokens(
                vault1Inheritor1
            );
        ...
        //     //confirm storage
        DMSFacet.AllocatedERC721Tokens[]
            memory vault1Inheritor2Alloc = v1dmsFacet.getAllocatedERC721Tokens(
                vault1Inheritor2
            );
        ...
        vault1Inheritor1Alloc = v1dmsFacet.getAllocatedERC721Tokens(
            vault1Inheritor1
        );
        ...
        v1dmsFacet.allocateERC721Tokens(
            address(erc721t),
            toSingletonAdd(address(0)),
            toSingletonUINT(0)
        );
        assertEq(
            v1dmsFacet
                .getAllocatedERC721TokenIds(vault1Inheritor2, address(erc721t))
                .length,
            0
        );
        //     //withdraw the token
        ...
        v1dmsFacet.allocateERC721Tokens(
            address(erc721t2),
            toSingletonAdd(mkaddr("noninheritor")),
            toSingletonUINT(1)
        );
        ...
        v1dmsFacet.allocateERC721Tokens(
            address(erc721t2),
            toTriAddress(vault1Inheritor2, vault1Inheritor2, vault1Inheritor2),
            toTriUINT(0, 1, 2)
        );

        //     //double check storage
        vault1Inheritor2Alloc = v1dmsFacet.getAllocatedERC721Tokens(
            vault1Inheritor2
        );
