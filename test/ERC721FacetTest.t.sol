...
contract ERC721FacetTest is DDeployments {
    ...
    function testERC721VaultOperations() public {
        ...
        v1dmsFacet.allocateERC721Tokens(address(erc721t), toDualAdd(vault1Inheritor1, vault1Inheritor1), toDualUINT(0, 3));
        ...
        //     //confirm storage
        DMSFacet.AllocatedERC721Tokens[] memory vault1Inheritor2Alloc = v1dmsFacet.getAllocatedERC721Tokens(vault1Inheritor2);
        ...
        v1dmsFacet.allocateERC721Tokens(address(erc721t2), toTriAddress(vault1Inheritor2, vault1Inheritor2, vault1Inheritor2), toTriUINT(0, 1, 2));
