...
import "../../Vault/facets/UpgradeFacetWithModule.sol";
...
contract ModuleUpgraderFacet is StorageLayout {
    function upgradeVaultWithModule(string calldata _moduleName, address _vault)
        external
    {
    ...
    function downgradeVaultWithModule(
